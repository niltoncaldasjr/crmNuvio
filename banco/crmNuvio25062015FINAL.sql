...
INSERT INTO `perfil` (`id`, `nome`, `ativo`, `datacadastrado`, `dataedicao`) VALUES
...
INSERT INTO `pessoafisica` (`id`, `nome`, `cpf`, `datanascimento`, `estadocivil`, `sexo`, `nomepai`, `nomemae`, `cor`, `naturalidade`, `nacionalidade`, `datacadastrado`, `dataedicao`) VALUES
...
-- Copiando dados para a tabela crmnuvio.usuario: ~0 rows (aproximadamente)
DELETE FROM `usuario`;
