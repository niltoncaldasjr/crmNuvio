Ext.define('crm.controller.Pais',{
    ...
    refs: [
    	...
    	{
            ref: 'TabPanel',
            selector: 'paistabpanel'
        },
    	{
            ref: 'Form',
            selector: 'paisform form'
        },
        {
            ref: 'PanelOeste',
            selector: 'paispanel panel#oeste'
        },
        {
            ref: 'PanelSul',
            selector: 'paispanel panel#sul'
        }
	...
	deletePais: function(btn, e, opts){
