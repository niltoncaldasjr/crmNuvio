...
function cadastraBanco() {
	...
	$objLogSistema->setOcorrencia('Inclusуo de registro na Classe Banco');
...
function atualizaBanco() {
	...
	// Resginstando Log do Sistema
	$objLogSistema = new LogSistema();
	$objLogSistema->setOcorrencia('Alteraчуo de registro na Classe Banco');
...
function deletaBanco() {
	...
	// Resginstando Log do Sistema
	$objLogSistema = new LogSistema();
	$objLogSistema->setOcorrencia('Exclusуo de registro na Classe Banco: ID '.$id);
