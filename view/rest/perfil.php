...
function cadastraPerfil() {
	...
	$log = new LogSistema();
	$log->setOcorrencia('Inclusуo de registro na Classe Perfil.');
	$log->setNivel('BASICO');
...
function atualizaPerfil() {
	...
	// REGISTA O LOG NO SISTEMA
	$log = new LogSistema();
	$log->setOcorrencia('Alteraчуo de registro na Classe Perfil.');
...
function deletaPerfil() {
	...
	// REGISTA O LOG NO SISTEMA
	$log = new LogSistema();
	$log->setOcorrencia('Exclusуo de registro na Classe Perfil.');
