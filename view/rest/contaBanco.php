...
function cadastraContaBanco() {
	...
	$objLogSistema->setOcorrencia('Inclusуo de registro na Classe ContaBanco');
...
function atualizaContaBanco() {
	...
	// Resginstando Log do Sistema
	$objLogSistema = new LogSistema();
	$objLogSistema->setOcorrencia('Alteraчуo de registro na Classe ContaBanco');
...
function deletaContaBanco() {
	...
	// Resginstando Log do Sistema
	$objLogSistema = new LogSistema();
	$objLogSistema->setOcorrencia('Exclusуo de registro na Classe ContaBanco: ID '.$id);
