...
function cadastraContaBanco() {
	...
	$objLogSistema->setOcorrencia( utf8_encode('Inclusуo de registro na Classe ContaBanco') );
...
function atualizaContaBanco() {
	...
	// Resginstando Log do Sistema
	$objLogSistema = new LogSistema();
	$objLogSistema->setOcorrencia( utf8_encode('Alteraчуo de registro na Classe ContaBanco') );
...
function deletaContaBanco() {
	...
	// Resginstando Log do Sistema
	$objLogSistema = new LogSistema();
	$objLogSistema->setOcorrencia( utf8_encode('Exclusуo de registro na Classe ContaBanco: ID '.$id) );
