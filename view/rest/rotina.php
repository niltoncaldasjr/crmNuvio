...
function cadastraRotina() {
	...
	$objLogSistema->setOcorrencia('Inclusуo de registro na Classe Rotina');
...
function atualizaRotina() {
	...
	// Resginstando Log do Sistema
	$objLogSistema = new LogSistema();
	$objLogSistema->setOcorrencia('Alteraчуo de registro na Classe Rotina.');
...
function deletaRotina() {
	...
	// Resginstando Log do Sistema
	$objLogSistema = new LogSistema();
	$objLogSistema->setOcorrencia('Exclusуo de resgistro na Classe Rotina: ID '.$id);
