...
function cadastraLocalidade() {
	...
	$log = new LogSistema();
	$log->setOcorrencia('Inclusуo de registro na Classe Localidade.');
	$log->setNivel('BASICO');
...
function atualizaLocalidade() {
	...
	// REGISTA O LOG NO SISTEMA
	$log = new LogSistema();
	$log->setOcorrencia('Alteraчуo de registro na Classe Localidade.');
...
function deletaLocalidade() {
	...
	// REGISTA O LOG NO SISTEMA
	$log = new LogSistema();
	$log->setOcorrencia('Exclusуo de registro na Classe Localidade.');
